...
var countQueueName = builder.Configuration.GetValue<string>("AzureStorage:CountQueueName");
builder.Services.AddSingleton<IQueueService>(sp => new QueueService(connectionString, queueName, countQueueName));
